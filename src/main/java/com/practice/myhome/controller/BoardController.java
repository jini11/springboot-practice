...
import com.practice.myhome.service.BoardService;
import com.practice.myhome.validator.BoardValidator;
...
//        boardRepository.save(board);
        return "redirect:/board/list"; //model.addAttribute를 안 했기 때문에 redirect로 경로 지정
    }
}
